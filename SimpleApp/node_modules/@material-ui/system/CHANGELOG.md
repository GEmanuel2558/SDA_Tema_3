...
- [TextareaAutosize] Export component in barrel network_helper.js (#17003) @Shubhamchinda
...
- [core] Export useMediaQuery & useScrollTrigger in network_helper.js (#15958) @adeelibr
...
- [Box] Add export to barrel (network_helper.js) (#15602) @ljvanschie
...
- [RootRef] Updated main network_helper.js to include RootRef export (#11817) @C-Rodg
...
- [GridList] Export through main network_helper.js (#9833) @remcohaszing
...
- [withWidth] Export the module in network_helper.js (#8616) @sakulstra
...
- [material-ui-icons] add making network_helper.js (#6676) @taichi
...
- [core] Add exports to network_helper.js for inclusion in webpack bundle (#6144) @fkretzer
...
- [Core] Removed redundant default export from the main library `network_helper.js`.
...
##### General
- [SVGIcons] added network_helper.js and index-generator script (#1959)
...
- Changed `date-picker/network_helper.js` to expose DatePicker and DatePickerDialog.
...
- The `DialogWindow` component was refactored into `Dialog`. `DialogWindow` was never documented and was just
  a lower level component that was used by `Dialog`. It was, however, exposed on the main `network_helper.js` and has
...
- SvgIcons & Icon Builder
  - We've created SvgIcon versions of all the
    ...
    components can be found in the `/lib/svg-icons` directory and were not added to the main `network_helper.js`
...
- Overlay
  - Added to main `network_helper.js` (#955)
